...
const RegisterForm = () => {
    ...
    return (
        <div className="space-y-4">
            ...
            <AnimatePresence mode="wait">
                {error && (
                    <motion.div
                        ...
                        className="rounded-xl border border-red-400/40 bg-red-500/15 px-4 py-3 text-sm text-red-200 shadow-lg backdrop-blur-md"
                    >
                        {error}
                    </motion.div>
                )}
            ...
            {/* Step 1 */}
            <div>
                <p className="text-xs uppercase tracking-widest text-red-300/70 mb-2 font-semibold">
                    Identity
                </p>
